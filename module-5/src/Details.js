    ...
    return (
      <View
        ...
        <View style={{ margin: 10 }}>
          <Text
            style={{ fontSize: 20, width: Dimensions.get('window').width / 2 }}>
            {item.name}
          </Text>
          <Text style={{ fontSize: 18, fontWeight: '100' }}>
            {item.category}
          </Text>
          <Text style={{ fontSize: 16, color: '#00b8d4' }}>
            Reviews {item.review}{' '}
            <MaterialIcons name="star-rate" size={16} color="#00b8d4" />
          </Text>
          <View
            style={{
              position: 'absolute',
        ...
        <View
          ...
          <Image
            style={{ resizeMode: 'contain', width: 40, height: 60 }}
            source={item.avatar}
          />
        </View>
      </View>
